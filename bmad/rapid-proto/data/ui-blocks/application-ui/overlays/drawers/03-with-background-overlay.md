...
category: Overlays
element: Drawers
variant: With background overlay
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
...
notes: |
  Drawer with semi-transparent backdrop overlay. DialogBackdrop animates opacity
  synchronized with panel slide. Backdrop dismisses drawer on click for intuitive
  interaction pattern.
---

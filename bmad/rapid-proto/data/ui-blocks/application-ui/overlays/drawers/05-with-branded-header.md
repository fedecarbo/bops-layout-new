...
notes: |
  Drawer with branded indigo header section. Header includes title, description,
  and close button with light text colors. Separates branding area from content

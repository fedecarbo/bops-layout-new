...
a11y:
  ...
  - sr-only labels for status and close button
  - Menu pattern for options
  - keyboard focus management
  - semantic time element
notes: |
  User profile drawer with cover image, avatar, status indicator, action buttons,
  and Menu dropdown. Features responsive button layout and definition list for
  profile information. Includes online status badge.
---

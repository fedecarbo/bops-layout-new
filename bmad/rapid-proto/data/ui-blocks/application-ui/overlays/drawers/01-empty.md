...
notes: |
  Basic right-side drawer with slide-in animation. Features translate-x transform
  with duration-based transitions. Max-w-md panel with empty content area ready
  for customization.
---

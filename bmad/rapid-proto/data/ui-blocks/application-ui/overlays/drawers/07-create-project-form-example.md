...
category: Overlays
element: Drawers
variant: Create project form example
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
...
tags:
  ...
  - branded-header
a11y:
  - Dialog component for drawer semantics
  - DialogTitle for accessible heading
  - sr-only labels for interactive elements
  - aria-hidden on decorative icons
  - aria-describedby for radio inputs
  - keyboard focus management
  - labeled form inputs
notes: |
  Full project creation form in drawer with branded header. Features text inputs,
  textarea, team member avatars, radio button privacy options, and action links.
  Uses h-0 flex-1 pattern for scrollable form content with sticky footer.
---

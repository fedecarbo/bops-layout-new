...
notes: |
  Drawer with sticky footer containing action buttons. Uses divide-y for visual
  separation. Content area scrolls independently while footer remains fixed at
  bottom. Features Cancel and Save buttons.
---

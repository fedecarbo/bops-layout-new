...
category: Overlays
element: Drawers
variant: Wide create project form example
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
...
a11y:
  ...
  - labeled form inputs
notes: |
  Wide drawer (max-w-2xl) with project creation form using grid layout. Features
  3-column grid for label/input pairs on larger screens. Uses horizontal layout
  for action links in privacy section with hr divider.
---

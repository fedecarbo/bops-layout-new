...
notes: |-
  Notification with icon, title, description, and action buttons below content. Actions positioned in horizontal row beneath message for better touch targets. Supports multiple action buttons with consistent spacing.
---

...
notes: |-
  Message-style notification with avatar, sender name, and message text. Single action button positioned in bordered right section. Layout uses flex with border-l divider to separate content from action area.
---

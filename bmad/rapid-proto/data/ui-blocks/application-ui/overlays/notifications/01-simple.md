...
a11y:
  ...
  - sr-only label on close button
  - aria-hidden on decorative icons
notes: |-
  Simple notification toast with success icon, title, description, and close button. Uses Headless UI Transition for smooth enter/exit animations. Fixed positioning in top-right corner (mobile: bottom, desktop: top). Includes pointer-events-none on container to allow clicking through overlay.
---

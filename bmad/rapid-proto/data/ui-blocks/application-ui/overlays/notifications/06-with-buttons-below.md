...
a11y:
  ...
  - empty alt text for decorative avatar
notes: |-
  Social notification with avatar, message, and action buttons (Accept/Decline) positioned below content. Uses contrasting button styles (filled primary vs outlined secondary). Close button in top-right corner.
---

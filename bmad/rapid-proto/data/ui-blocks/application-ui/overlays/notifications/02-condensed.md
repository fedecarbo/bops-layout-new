...
notes: |-
  Compact notification with single-line message and inline undo action. Uses horizontal flex layout to fit title and action on same line. No icon for minimal space usage. Ideal for quick confirmations with reversible actions.
---

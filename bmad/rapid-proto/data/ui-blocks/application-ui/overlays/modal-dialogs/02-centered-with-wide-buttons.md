...
variant: Centered with wide buttons
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
...
notes: |
  Success-style modal with two-button grid layout. Uses grid-flow-row-dense
  for responsive button ordering. Features data-autofocus attribute for focus
  management and wider max-w-lg panel.
---

...
variant: Centered with single action
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
...
notes: |
  Success-style centered modal with single action button. Features animated
  backdrop and panel transitions using data-attributes. Includes responsive
  layout with transform animations on open/close.
---

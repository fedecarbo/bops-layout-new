...
a11y:
  ...
  - Listbox component provides ARIA semantics
  - sr-only labels on icon buttons
  - aria-hidden on decorative spacer
notes: |
  Comment textarea with avatar and floating toolbar. Uses focus-within for unified
  focus ring. Toolbar positioned absolutely at bottom with mood picker (Listbox) and
  attachment button. Spacer element ensures textarea height accommodates toolbar.
---

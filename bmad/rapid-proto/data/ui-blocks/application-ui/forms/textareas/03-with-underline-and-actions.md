...
category: Forms
element: Textareas
variant: With underline and actions
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
...
notes: |
  Comment textarea with bottom border styling instead of full outline. Uses border-b
  with focus-within:border-b-2 for animated underline effect. Toolbar positioned below
  with mood picker and attachment button.
---

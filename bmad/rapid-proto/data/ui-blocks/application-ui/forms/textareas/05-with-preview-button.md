...
tags:
  ...
  - form-field
a11y:
  - Tab components provide proper ARIA semantics
  - sr-only label for textarea
  - sr-only labels on toolbar buttons
notes: |
  Textarea with Write/Preview tabs using Headless UI TabGroup. Toolbar buttons
  conditionally shown using group-has-[*:first-child[aria-selected='true']] selector.
  Preview panel styled with border-b. data-selected state styling on active tab.
---

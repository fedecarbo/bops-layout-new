...
notes: |
  Simple combobox with search/filter functionality using Headless UI. Features text input
  with dropdown chevron button and filtered options list. Supports creating new entries by
  typing. Uses data-focus states for option highlighting and smooth transitions on close.
---

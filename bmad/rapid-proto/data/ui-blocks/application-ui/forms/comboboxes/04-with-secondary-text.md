...
notes: |
  Combobox with secondary text (username) displayed inline next to primary text (name).
  Secondary text uses gray color that changes to white when option is focused via
  in-data-focus modifier. Both text spans use truncate for overflow handling.
---

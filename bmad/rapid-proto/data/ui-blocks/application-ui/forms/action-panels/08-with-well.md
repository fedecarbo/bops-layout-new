...
a11y:
  ...
  - sr-only heading for card brand
  - aria-hidden on decorative elements
  - descriptive button text
notes: |
  Action panel containing nested gray well with payment method details. Well uses responsive
  flex layout to show credit card icon, details, and edit button. Includes SVG card logo,
  card info with responsive separator dots, and secondary button style.
---

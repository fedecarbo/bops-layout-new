...
notes: |
  Toggle with animated icon indicators inside the knob. Uses opacity transitions to swap
  between X icon (unchecked) and checkmark icon (checked). Icons are absolutely positioned
  within the relative knob span and transition with different durations for smooth effect.
---

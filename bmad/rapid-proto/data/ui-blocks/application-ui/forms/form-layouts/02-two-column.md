...
notes: |
  Two-column responsive layout with description on left (1 column) and form fields on right (2 columns).
  Uses md:grid-cols-3 pattern where description takes 1 column and form fields span 2 columns.
  Fields within form section use nested sm:grid-cols-6 for flexible widths. Transitions to stacked on mobile.
---

...
a11y:
  ...
  - sr-only for hidden file input
  - aria-hidden on decorative icons
notes: |
  Comprehensive stacked form layout with three sections (Profile, Personal Information, Notifications).
  Uses CSS Grid for responsive column layouts with sm:grid-cols-6 pattern for flexible field widths.
  Custom checkbox and radio inputs using grid overlay technique with SVG check/indeterminate marks.
  Select inputs use grid positioning to overlay the chevron icon.
---

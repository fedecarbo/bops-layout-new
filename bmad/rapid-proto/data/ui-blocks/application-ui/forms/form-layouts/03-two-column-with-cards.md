...
notes: |
  Card-based two-column layout where each section is a separate form card with shadow and outline.
  Uses divide-y on container and md:grid-cols-3 pattern with description on left, card form on right.
  Each form card has its own submit/cancel buttons in a bordered footer section.
---

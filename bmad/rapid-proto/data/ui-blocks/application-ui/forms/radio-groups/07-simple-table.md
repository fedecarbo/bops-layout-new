...
notes: |
  Table-like radio group using grid layout with 3 columns on desktop. Uses label elements
  with has-checked pseudo-class for checked state styling including background and border color.
  Fully clickable label areas with hidden radio input.
---

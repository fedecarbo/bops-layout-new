...
notes: |
  Similar to list with description but description appears inline with label on the same line
  using span instead of p element. Description still properly associated via aria-describedby
  for accessibility.
---

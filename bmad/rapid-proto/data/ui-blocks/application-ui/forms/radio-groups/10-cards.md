...
notes: |
  Card-based radio group in responsive grid layout (1 column mobile, 3 columns desktop).
  Uses label as card container with has-checked for checked state styling. CheckCircleIcon
  appears only on checked cards using group-has-checked:visible pattern.
---

...
notes: |
  Radio group with stacked description text below each label. Uses aria-describedby to
  associate description with radio input for screen readers. Description styled with
  text-gray-500 for visual hierarchy.
---

...
variant: Simple list with radio on right
tech: React
tailwind: v4.1
deps: []
tags:
...
notes: |
  Simplified version of radio-on-right layout without descriptions. Uses border-t and border-b
  with divide-y for bordered list appearance. Label includes select-none to prevent accidental
  text selection during clicks.
---

...
notes: |
  Simple radio button list using native HTML radio inputs with custom Tailwind styling.
  Uses appearance-none with before pseudo-element for custom radio indicator.
  Includes focus-visible states and forced-colors mode support for accessibility.
---

...
a11y:
  ...
  - aria-label on radio inputs for color names
  - keyboard navigation support
  - focus-visible states
notes: |
  Visual color picker using radio buttons styled as colored circles. Each color option
  includes dynamic classes for background and checked outline color. Uses classNames helper
  function to combine classes. Radio inputs have appearance-none with colored backgrounds.
---

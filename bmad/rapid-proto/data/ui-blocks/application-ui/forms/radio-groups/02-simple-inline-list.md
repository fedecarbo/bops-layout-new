...
notes: |
  Simple radio button list with responsive layout that switches from vertical stacking on mobile
  to horizontal inline layout on larger screens using sm:flex. Same custom radio styling as simple list
  with space-x-10 for horizontal spacing.
---

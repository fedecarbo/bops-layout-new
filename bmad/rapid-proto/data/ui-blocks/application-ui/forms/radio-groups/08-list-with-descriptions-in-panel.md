...
variant: List with descriptions in panel
tech: React
tailwind: v4.1
deps: []
tags:
...
a11y:
  ...
  - label with aria-label and aria-description
  - keyboard navigation support
  - has-checked state for visual feedback
notes: |
  Radio group with panel-style layout using label elements as clickable containers.
  Uses has-checked pseudo-class for checked state styling with indigo background and border.
  Radio input positioned absolutely with appearance-none for custom styling.
---

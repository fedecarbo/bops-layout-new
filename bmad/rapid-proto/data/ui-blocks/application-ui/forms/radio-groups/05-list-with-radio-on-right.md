...
variant: List with radio on right
tech: React
tailwind: v4.1
deps: []
tags:
...
notes: |
  Radio buttons positioned on the right side with label and description on left.
  Uses divide-y for horizontal dividers between items. Flex layout with flex-1 for
  content and fixed width for radio control.
---

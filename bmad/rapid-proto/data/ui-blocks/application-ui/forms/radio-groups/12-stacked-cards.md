...
notes: |
  Full-width stacked card layout with responsive flex to grid transition. Cards display plan
  details with name/specs on left and pricing on right. Uses has-checked for outline styling
  and label element as full clickable area with absolutely positioned radio input.
---

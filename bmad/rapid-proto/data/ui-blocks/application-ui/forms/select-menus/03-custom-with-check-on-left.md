...
variant: Custom with check on left
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
...
a11y:
  ...
  - CheckIcon indicates selected option
  - keyboard navigation support
notes: |
  Custom select with check mark positioned on left side of options. ListboxOption
  uses pl-8 for left padding and absolute positioning for check icon at left edge.
---

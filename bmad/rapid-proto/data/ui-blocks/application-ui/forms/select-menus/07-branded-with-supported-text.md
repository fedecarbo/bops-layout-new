...
variant: Branded with supported text
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
...
tags:
  ...
  - description
a11y:
  - sr-only label provides accessible name
  - keyboard navigation support
  - forced-colors support for chevron icon
notes: |
  Branded split-button select with status display and descriptions. Uses divide-x
  for separator, inline-flex for layout. Options show title and description in flex-col layout.
---

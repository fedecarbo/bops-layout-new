...
notes: |
  Custom select using Headless UI Listbox with check mark on right. ListboxButton
  uses grid layout for text truncation. Options animate on close with data-leave transitions.
---

...
notes: |
  Custom select with secondary text (username). Uses flexbox with gap-2 in button,
  secondary text styled in gray-500. Options adapt text color on focus with group-data-focus:text-indigo-200.
---

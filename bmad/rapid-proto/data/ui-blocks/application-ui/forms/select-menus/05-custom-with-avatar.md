...
a11y:
  ...
  - empty alt attributes on avatar images (decorative)
  - keyboard navigation support
notes: |
  Custom select with user avatar images. Button and options use flexbox with gap-3
  for spacing. Avatars are rounded-full with shrink-0 to prevent squishing.
---

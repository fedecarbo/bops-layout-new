...
variant: Input with inline leading dropdown
tech: React
tailwind: v4.1
deps:
...
notes: |
  Input with inline leading select dropdown. Uses CSS Grid for dropdown with overlaid
  chevron icon. Container uses has-[input:focus-within] for unified focus ring.
---

...
variant: Input with inline leading add-on and trailing dropdown
tech: React
tailwind: v4.1
deps:
...
tags:
  ...
  - inline
a11y:
  - aria-label on select for accessibility without visible label
  - aria-hidden on decorative chevron icon
notes: |
  Complex inline input with text add-on at start and select dropdown at end. Uses
  has-[input:focus-within] for unified focus ring when input focused.
---

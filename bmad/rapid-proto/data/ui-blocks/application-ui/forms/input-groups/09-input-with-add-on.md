...
notes: |
  Input with separate leading add-on element. Uses flexbox with add-on as separate div
  with rounded-l-md, input has rounded-r-md and -ml-px for seamless connection.
---

...
variant: Inputs with inset labels and shared borders
tech: React
tailwind: v4.1
deps: []
tags:
...
a11y:
  ...
  - focus-within:relative for proper focus ring layering
notes: |
  Stacked inputs with inset labels sharing borders. Uses -space-y-px to collapse borders
  between fields. Each field has focus-within:relative for proper z-index stacking.
---

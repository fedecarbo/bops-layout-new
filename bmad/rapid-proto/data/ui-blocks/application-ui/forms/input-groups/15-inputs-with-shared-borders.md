...
variant: Inputs with shared borders
tech: React
tailwind: v4.1
deps:
...
a11y:
  ...
  - focus:relative for proper focus ring layering
notes: |
  Complex form with shared borders between inputs. Uses negative margins (-mt-px, -mr-px)
  to collapse borders. Grid layout for card fields, focus:relative ensures active field appears on top.
---

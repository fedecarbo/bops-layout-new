...
notes: |
  Card-based sign-in form on gray background. Form contained in white card with shadow-sm
  and rounded corners. Includes social login options with horizontal divider using border-t
  and text-nowrap. Requires h-full and bg-gray-50 on html/body.
---

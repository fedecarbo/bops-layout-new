...
category: Forms
element: Sign-in and Registration
...
tags:
  ...
  - checkbox
a11y:
  - labels associated with inputs and checkbox
  - aria-hidden on decorative divider
  - semantic form element
  - SVG icons have aria-hidden attribute
notes: |
  Split-screen layout with form on left and image on right. Left side uses lg:flex-none
  with fixed width, right side has flex-1. Includes social login buttons (Google, GitHub)
  with divider. Custom checkbox pattern with SVG checkmark overlay.
---

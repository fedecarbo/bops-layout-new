...
a11y:
  ...
  - focus:relative for proper focus ring stacking
  - custom checkbox with SVG checkmark
notes: |
  Sign-in form with shared border inputs (no visible labels). Uses -mt-px to collapse
  borders between stacked inputs. Custom checkbox with CSS Grid and SVG overlay. Remember
  me and forgot password in justify-between layout.
---

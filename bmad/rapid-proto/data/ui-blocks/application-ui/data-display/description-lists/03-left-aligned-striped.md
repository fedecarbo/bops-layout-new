...
notes: |
  Striped description list with alternating row backgrounds for improved readability.
  Uses semantic HTML with dl/dt/dd elements and alternates between gray-800/25 and gray-900 backgrounds.
  Includes section header, divided rows, and attachments section with file list.
  Responsive: stacks on mobile, 3-column grid on sm+ breakpoints.
---

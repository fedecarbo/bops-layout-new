...
notes: |
  Dark-themed description list with left-aligned labels and responsive grid layout.
  Uses semantic HTML with dl/dt/dd elements for proper structure.
  Includes section header, divided rows, and an attachments section with file list.

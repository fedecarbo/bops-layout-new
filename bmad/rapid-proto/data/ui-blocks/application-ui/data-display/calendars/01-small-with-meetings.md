...
tags:
  ...
  - responsive
a11y:
  - sr-only labels for navigation and field labels
  - aria-hidden on decorative icons
  - semantic time elements
  - menu pattern with HeadlessUI
  - keyboard focus management
notes: |
  Two-column layout combining a compact calendar grid with a meeting list.
  Calendar uses data attributes with Tailwind's data-* variants for complex state styling (today, selected, current month).
  Meeting list features avatar images, icon-based metadata, and dropdown menus for actions.
  Calendar grid uses isolate with gap-px and ring for visual separation between dates.
  Responsive: stacked on mobile, side-by-side grid layout on lg+ breakpoints.
---

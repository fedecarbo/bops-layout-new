...
notes: |
  Dropdown menu with contextual header showing user information. Header displays signed-in email with truncation. Dividers separate header from action sections. Common pattern for user account menus.
---

...
a11y:
  ...
  - group state focus indicators
notes: |
  Enhanced dropdown with icons for each menu item. Icons change color on focus using group-data-focus utility. Combines dividers for visual grouping with icon-based visual affordances for each action type.
---

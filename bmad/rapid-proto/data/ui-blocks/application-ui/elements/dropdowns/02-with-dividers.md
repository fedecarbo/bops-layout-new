...
notes: |
  Dropdown menu with visual dividers separating grouped actions. Uses Tailwind's divide utility to create horizontal borders between menu sections. Organizes related actions into logical groups.
---

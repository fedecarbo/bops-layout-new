...
notes: |-
  Pill-shaped flat badges with leading status dot. Combines rounded-full shape with solid backgrounds and colored dots. Provides softer visual alternative to standard badges while maintaining status indication.
---

...
notes: |-
  Compact flat badges with leading status dot and reduced padding. Combines px-1.5 py-0.5 with gap-x-1.5 spacing and SVG status dots. Space-efficient design with visual status indication.
---

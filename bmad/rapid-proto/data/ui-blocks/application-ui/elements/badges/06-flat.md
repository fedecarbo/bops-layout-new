...
notes: |-
  Flat badges without borders using stronger background colors (100 shade vs 50). Simple design with rounded-md corners. Eight color variants with increased color saturation compared to bordered versions.
---

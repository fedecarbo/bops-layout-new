...
variant: With checkbox and dropdown
tech: React
tailwind: v4.1
deps:
...
notes: |
  Composite control combining checkbox for bulk selection with dropdown filter. Uses CSS grid for select styling overlay with chevron icon. Common pattern for table bulk actions or filtered list controls.
---

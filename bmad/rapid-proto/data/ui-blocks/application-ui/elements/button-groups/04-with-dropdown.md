...
notes: |
  Split button pattern combining primary action with dropdown menu for related actions. Left button executes default action, right chevron reveals alternatives. Uses Headless UI Menu for accessible dropdown.
---

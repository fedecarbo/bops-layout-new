...
a11y:
  ...
  - back navigation landmark
  - aria-current for current page
  - aria-hidden on decorative icons
  - semantic heading hierarchy
notes: |
  Page heading with breadcrumb navigation and action buttons.
  Shows responsive breadcrumbs (full on desktop, simple back link on mobile).
  Uses dark theme with proper ARIA labels for navigation landmarks and
  current page indicators for accessibility.
---

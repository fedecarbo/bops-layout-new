...
notes: |
  Page heading with company logo, invoice metadata, and action buttons.
  Logo displayed as circular image with outline border.
  Two-line heading shows invoice number with entity name.
  Actions visible as individual buttons/links on desktop, collapsed to
  ellipsis menu on mobile using Headless UI Menu component.
---

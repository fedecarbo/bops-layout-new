...
notes: |
  Comprehensive page heading combining breadcrumbs, title, metadata, and actions.
  Breadcrumb navigation always visible (no mobile simplification).
  Metadata badges display job details with icons (employment, location, salary, deadline).
  Responsive action buttons collapse to dropdown menu on mobile, expand to individual
  buttons on desktop using Headless UI Menu component.
---

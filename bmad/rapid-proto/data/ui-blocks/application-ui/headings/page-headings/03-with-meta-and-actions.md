...
notes: |
  Page heading with metadata badges and multiple action buttons.
  Displays job details (employment type, location, salary, deadline) with icons.
  Responsive layout shows dropdown menu on mobile and individual buttons on desktop.
  Uses Headless UI Menu component with proper transitions and focus states.
---

...
notes: |
  Section heading combining title, action buttons, and responsive tab navigation.
  Uses relative positioning on container with absolute positioning for buttons at md breakpoint
  (md:absolute md:top-3 md:right-0) to overlay actions above tabs on desktop.
  Mobile shows dropdown selector, desktop shows horizontal underline tabs.
  Negative bottom margin (-mb-px) on nav overlaps tabs with section border.

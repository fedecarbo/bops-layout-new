...
variant: With inline links and avatar group
tech: React
tailwind: v4.1
deps:
...
a11y:
  ...
  - sr-only labels for icon meanings
  - time element with datetime attribute
  - alt attributes on commenter avatars
  - aria-hidden="true" on decorative status icons
notes: |
  Discussion list with inline author/date links and overlapping avatar groups.
  Uses description list (dl/dt/dd) for commenters and comment count with status icons.
  Responsive flex layout wraps on mobile, stays inline on desktop.
---

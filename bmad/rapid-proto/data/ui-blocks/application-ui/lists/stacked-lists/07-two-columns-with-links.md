...
variant: Two columns with links
tech: React
tailwind: v4.1
deps:
...
notes: |
  Two-column layout with equal-width sections on desktop (sm:w-1/2).
  Left column shows avatar and user details, right column displays role and status.
  Uses fixed column widths on larger screens for balanced visual alignment.
---

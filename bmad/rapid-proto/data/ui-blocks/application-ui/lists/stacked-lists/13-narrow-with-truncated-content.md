...
variant: Narrow with truncated content
tech: React
tailwind: v4.1
deps: []
tags:
...
notes: |
  Comment list with truncated content using line-clamp-2 for two-line preview.
  Timestamp displayed in header alongside commenter name.
  Compact layout ideal for activity feeds, comment previews, or notification lists.
---

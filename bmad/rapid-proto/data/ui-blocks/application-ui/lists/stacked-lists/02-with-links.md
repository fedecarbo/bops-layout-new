...
notes: |
  Interactive stacked list with clickable rows using absolute positioning technique.
  Email links use relative positioning to escape the row click target.
  Chevron icon indicates clickability. Status shown via emerald dot or timestamp.
---

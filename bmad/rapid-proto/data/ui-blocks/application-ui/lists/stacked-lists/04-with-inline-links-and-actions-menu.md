...
category: Lists
element: Stacked Lists
variant: With inline links and actions menu
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
...
a11y:
  ...
  - sr-only labels for menu button and context
  - aria-hidden="true" on decorative ellipsis icon
  - time element with datetime attribute
  - alt="" for decorative avatar images
  - menu pattern via Headless UI
notes: |
  Interactive people list with inline name/email links and actions dropdown menu.
  Uses Headless UI Menu component with transition animations for the dropdown.
  Status shown via emerald dot indicator or "last seen" timestamp.
---

...
variant: Narrow with small avatars
tech: React
tailwind: v4.1
deps: []
tags:
...
a11y:
  ...
  - heading element (h3) for user names
notes: |
  Compact activity feed with small 6x6 avatars and truncated content.
  Displays git commit activity with project name, commit hash, and branch.
  Uses monospace font for commit hash and semantic HTML with heading elements.
---

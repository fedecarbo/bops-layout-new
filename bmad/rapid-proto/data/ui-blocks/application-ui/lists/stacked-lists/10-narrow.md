...
notes: |
  Minimal, narrow list layout with just avatar, name, and email.
  No interactive elements or additional metadata. Compact design ideal for sidebars or constrained spaces.
  Uses simple flexbox layout with truncated email text.
---

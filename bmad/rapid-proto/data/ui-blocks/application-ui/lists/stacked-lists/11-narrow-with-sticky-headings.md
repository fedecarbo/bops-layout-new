...
variant: Narrow with sticky headings
tech: React
tailwind: v4.1
deps: []
tags:
  ...
  - grouped
a11y:
  - nav landmark with aria-label for directory navigation
  - role="list" for semantic list structure
  - alt="" for decorative avatar images
  - heading elements (h3) for section labels
notes: |
  Alphabetically grouped directory with sticky section headings.
  Headings use sticky positioning with z-index layering and subtle overlay effect.
  Full-height scrollable container with overflow-y-auto. Ideal for contact lists and directories.
---

...
notes: |
  Clean stacked list with avatars, user details, and online status indicators.
  Uses flexbox for horizontal alignment and responsive visibility for role/status.

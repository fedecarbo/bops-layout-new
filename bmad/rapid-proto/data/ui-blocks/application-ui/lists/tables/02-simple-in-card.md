...
notes: |
  Data table wrapped in a card container with rounded corners and outline border.
  Header has semi-transparent background (bg-gray-800/75) and body uses bg-gray-800/50.
  Rounded corners applied responsively (sm:rounded-lg) with overflow-hidden for clean edges.
---

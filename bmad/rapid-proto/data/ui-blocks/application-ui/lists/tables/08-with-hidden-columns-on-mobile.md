...
category: Lists
element: Tables
variant: With hidden columns on mobile
tech: React
tailwind: v4.1
deps: []
tags:
...
notes: |
  Responsive table that progressively hides less critical columns on smaller screens.
  Title hidden below sm, Email hidden below lg. No stacking - columns simply disappear.
  Simpler alternative to stacking pattern when some data can be omitted on mobile.
---

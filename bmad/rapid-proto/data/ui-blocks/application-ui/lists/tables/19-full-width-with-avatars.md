...
category: Lists
element: Tables
variant: Full width with avatars
tech: React
tailwind: v4.1
deps: []
tags:
...
a11y:
  ...
  - alt="" for decorative avatar images
notes: |
  Full-width activity table with avatars and deployment information.
  Uses colgroup for precise column width control (w-full sm:w-4/12, lg:w-4/12, lg:w-2/12, lg:w-1/12).
  Status indicators: green dot for Completed, rose dot for Error.
  Commit hash in monospace font with branch badge. Progressive disclosure: Commit hidden <sm, Duration hidden <md.
  On mobile, date shows in Status column instead of Deployed column. Contained in bg-gray-900 wrapper with py-10.
---

...
category: Lists
element: Tables
variant: With avatars and multi-line content
tech: React
tailwind: v4.1
deps: []
tags:
...
notes: |
  Rich data table with avatars and multi-line cells showing secondary information.
  Name column displays avatar with name/email stacked. Title column shows title/department.
  Status badge with colored background and ring. Larger vertical padding (py-5) for multi-line content.
---

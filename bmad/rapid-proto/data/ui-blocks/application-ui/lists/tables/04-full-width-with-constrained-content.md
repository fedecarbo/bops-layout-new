...
notes: |
  Table with content constrained to max-w-7xl while borders extend full viewport width.
  Uses absolute positioned pseudo-elements (divs) to create full-width borders.
  Progressive disclosure: Title hidden <sm, Email hidden <md. No horizontal scroll needed.
---

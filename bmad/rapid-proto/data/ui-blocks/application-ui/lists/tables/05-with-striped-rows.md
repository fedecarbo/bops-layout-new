...
notes: |
  Data table with alternating row backgrounds using even:bg-gray-800/50.
  Creates zebra-striping effect for improved readability on long tables.
  Base tbody has bg-gray-900, even rows have semi-transparent overlay.
---

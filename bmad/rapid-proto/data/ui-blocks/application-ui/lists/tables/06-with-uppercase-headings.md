...
category: Lists
element: Tables
variant: With uppercase headings
tech: React
tailwind: v4.1
deps: []
tags:
...
notes: |
  Data table with uppercase column headers using text-transform and tracking.
  Headers styled with text-xs, font-medium, tracking-wide, and text-gray-400.
  Creates a more subtle, professional header appearance compared to bold white headers.
---

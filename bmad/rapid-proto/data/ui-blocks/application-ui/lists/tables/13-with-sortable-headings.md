...
category: Lists
element: Tables
variant: With sortable headings
tech: React
tailwind: v4.1
deps:
...
notes: |
  Interactive table with sortable column headers using clickable links.
  Chevron icons indicate sort direction - visible on active sort (Title), hidden on others.
  Icons become visible on hover/focus using invisible + group-hover:visible pattern.
  Active sort column shows icon with bg-gray-800 background, hover shows bg-gray-700.
---

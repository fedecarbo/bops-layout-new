...
notes: |
  Full-width table with responsive padding that scales across breakpoints.
  First and last columns have progressive padding: pl-4/pr-4 (mobile) → pl-6/pr-6 (tablet) → pl-8/pr-8 (desktop).
  Background on tbody (bg-gray-900) extends full width for consistent appearance.
---

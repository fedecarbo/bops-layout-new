...
a11y:
  ...
  - sr-only labels for definition terms
  - aria-hidden on decorative icons
  - accessible link text with icons
notes: |
  Centered contact cards with large avatars (32x32) and responsive grid from 1 to 4 columns.
  Uses flexbox flex-col for vertical layout with definition list for semantic title/role structure.
  Split action buttons maintain equal width with divide borders.
---

...
category: Lists
element: Grid Lists
variant: Contact cards with small portraits
tech: React
tailwind: v4.1
deps:
...
a11y:
  ...
  - accessible link text with icons
notes: |
  Responsive grid layout that adapts from 1 column on mobile to 3 columns on large screens.
  Each card displays contact information with a badge and avatar, divided into content and action sections.
  Action buttons use flex-1 with divide borders for equal-width split layout.
---

...
notes: |
  Empty state with project template options in vertical list format.
  Features colored icon badges and chevron indicators. Uses absolute positioning
  for full-item clickability with hover states.
---

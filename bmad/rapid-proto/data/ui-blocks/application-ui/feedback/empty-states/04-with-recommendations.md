...
a11y:
  ...
  - sr-only context for invite buttons
  - role="list" for recommendations
  - keyboard focus indicators
notes: |
  Empty state with email invite form and recommended team members list.
  Features centered layout with avatar list and individual invite actions.
  Maximum width constrained for optimal readability.
---

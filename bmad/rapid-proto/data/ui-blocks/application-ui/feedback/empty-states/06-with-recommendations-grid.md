...
variant: With recommendations grid
tech: React
tailwind: v4.1
deps:
...
tags:
  ...
  - select
a11y:
  - aria-label for input fields
  - aria-hidden on decorative icons
  - role="list" for recommendations
  - keyboard focus indicators
notes: |
  Empty state with combined input/select form and team recommendations in responsive grid.
  Features rounded pill-style recommendation cards with avatar and add button.
  Uses has-[] pseudo-class for modern focus styling on input container.
---

...
notes: |
  Dark sidebar with off-white main content area background implied by template comments.
  Profile section at sidebar bottom uses full-width (-mx-6) design with user avatar and name.
  Mobile header uses after pseudo-element for layered border and background effect.
  No separate header bar on desktop - content flows directly after sidebar with pl-72 offset.
---

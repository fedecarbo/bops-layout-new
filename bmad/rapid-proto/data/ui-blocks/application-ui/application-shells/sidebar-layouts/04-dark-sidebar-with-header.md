...
notes: |
  Dark sidebar variant with subtle ring border on desktop sidebar (ring-1 ring-white/10).
  Simplified icon styling without hover color transitions on navigation items.
  Settings link uses text-gray-400 base color matching the streamlined visual approach.
  Header includes shadow-xs utility for subtle depth effect.
---

...
notes: |
  Sidebar layout with constrained content area using max-w-7xl container.
  Header wraps content in mx-auto max-w-7xl px-8 on desktop, removing padding with lg:px-0 on header flex.
  Main content area also constrained with mx-auto max-w-7xl pattern.
  Settings link uses text-gray-300 base color for subtle distinction from navigation items.
---

...
notes: |
  Brand-colored indigo sidebar with dark gray-900 header bar containing search and profile.
  Settings link at sidebar bottom uses indigo-100 text with hover transitions.
  Header uses grid-based search input overlay pattern and Headless UI Menu for profile dropdown.
  Sidebar uses after pseudo-element for right border separator on desktop.
---

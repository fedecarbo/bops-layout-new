...
notes: |
  Dark-themed sidebar layout with fixed desktop sidebar and mobile dialog overlay.
  Features main navigation icons, team switcher with initials badges, and profile section.
  Uses Headless UI Dialog with slide-in transition for mobile, fixed 288px sidebar on desktop.
  Sticky top bar on mobile contains menu trigger and profile avatar.
---

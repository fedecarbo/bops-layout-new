...
notes: |
  Sidebar layout with sticky top header bar featuring search, notifications, and profile dropdown.
  Settings link positioned at bottom of sidebar with mt-auto.
  Header contains grid-based search input with icon overlay, notification bell, and Headless UI Menu for profile.
  Main content area offset by sidebar width (pl-72) on desktop.
---

...
notes: |
  Full dark application shell with stacked layout and bottom-bordered navbar.
  Desktop shows horizontal nav with border-b-2 active indicators, mobile uses Disclosure with slide-out panel.
  Profile dropdown uses HeadlessUI Menu with transitions, notification bell button in header.
  Mobile menu includes user profile section with avatar, name, email at bottom.
  Main content area with header (h1) and constrained max-w-7xl containers throughout.
---

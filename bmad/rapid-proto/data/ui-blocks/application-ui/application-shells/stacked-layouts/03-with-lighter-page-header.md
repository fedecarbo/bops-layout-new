...
notes: |
  Dark application shell with lighter bg-gray-800 page header section.
  Navigation uses rounded-md pills (not border indicators) with bg-gray-950/50 active state.
  Header has after pseudo-element for border-y with border-white/10, relative positioning.
  Desktop shows md breakpoint (not sm), navigation with ml-10 and space-x-4 spacing.
  Mobile menu uses rounded-md buttons matching desktop style, no left borders.
---

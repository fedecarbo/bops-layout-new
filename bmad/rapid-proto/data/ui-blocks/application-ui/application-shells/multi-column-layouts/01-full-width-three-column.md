...
variant: Full-width three-column
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
...
notes: |
  Three-column layout with left sidebar (w-72), middle secondary column (w-96), and main content.
  Secondary column fixed at left-72 offset, visible only on xl breakpoint.
  Main content has xl:pl-96 offset to accommodate secondary column.
  Uses before pseudo-elements for layered borders and backgrounds on sidebar and mobile header.
---

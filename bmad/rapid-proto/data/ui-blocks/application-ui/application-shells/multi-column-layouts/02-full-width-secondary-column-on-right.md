...
variant: Full-width secondary column on right
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
...
notes: |
  Three-column layout with left sidebar (w-72), main content in center, and right secondary column (w-96).
  Secondary column fixed at right-0, visible only on xl breakpoint with border-l.
  Main content has xl:pr-96 offset to accommodate right secondary column.
  Icon colors use gray-500 for inactive state, creating subtle visual hierarchy.
---

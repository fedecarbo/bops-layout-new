...
notes: |
  Dark vertical progress indicator with bullets and text labels stacked vertically.
  Complete steps show CheckCircleIcon (size-full text-indigo-400), current has outer ring with inner dot.
  Upcoming steps use small bullets (size-2 bg-white/15) with hover states.
  Space-y-6 vertical spacing, centered layout with responsive padding, labels positioned with ml-3.
---

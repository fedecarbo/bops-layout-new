...
a11y:
  ...
  - aria-hidden on decorative circles and connecting lines
notes: |
  Dark vertical progress with circular indicators, connecting lines, and detailed descriptions.
  Complete steps show CheckIcon in bg-indigo-500 with indigo connecting line (w-0.5).
  Current step has border-indigo-500 ring with inner dot and gray-700 line, upcoming use border-white/15.
  Vertical lines positioned absolutely (top-4 left-4 -ml-px), pb-10 spacing between steps.
  Text layout uses flex-col with step name and description, ml-4 spacing from circles.
---

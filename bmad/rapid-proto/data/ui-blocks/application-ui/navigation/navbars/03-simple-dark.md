...
notes: |
  Minimal navbar with no dynamic data arrays.
  Static navigation links in both desktop and mobile views.
  Mobile menu button positioned on right.
  User profile section in mobile menu with border separator.
---

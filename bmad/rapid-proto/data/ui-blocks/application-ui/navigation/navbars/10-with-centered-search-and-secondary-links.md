...
category: Navigation
element: Navbars
variant: With centered search and secondary links
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
...
notes: |
  Two-row dark navbar with centered search and secondary navigation. Similar to variant 09 but with lighter active state styling (bg-white/5 instead of bg-gray-950/50). Desktop uses divide-y separator between rows. Search centered via absolute positioning on desktop. Navigation items use rounded backgrounds for active/hover states.
---

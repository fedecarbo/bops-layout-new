...
category: Navigation
element: Navbars
variant: Simple with menu button on left
tech: React
tailwind: v4.1
deps:
  - '@headlessui/react'
  - '@heroicons/react/24/outline'
tags: [navigation, navbar, dark, responsive, mobile-menu, underline]
a11y:
  - "Uses <nav> landmark"
...
notes: |
  ...
  No user profile section in mobile menu (profile/bell only on desktop).
---

...
notes: |
  Dark navbar with bottom border indicator navigation. Desktop navigation uses inline bottom borders (border-b-2) to indicate active state. Mobile navigation uses left border accent (border-l-4) with background color. Search bar centered on mobile, right-aligned on desktop with grid-based icon overlay.
---

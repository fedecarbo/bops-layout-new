...
tags: [navigation, navbar, dark, responsive, mobile-menu, underline, cta]
a11y:
  - "Uses <nav> landmark"
...
notes: |
  Desktop nav uses bottom border (border-b-2) for active state.
  Includes prominent CTA button (New Job) with PlusIcon.
  Mobile menu button positioned on left.
  Mobile nav uses left border (border-l-4) for active state.
  Mobile menu includes user profile section with border separator.
  Responsive padding (sm:pr-6 sm:pl-5) on mobile nav items.
---

...
notes: |
  Dark vertical navigation combining icons, labels, and optional count badges.
  Icons use size-6 with shrink-0, colored gray-500 by default and white when active/hover.
  Badges align right with ml-auto, using bg-gray-900 with outline styling.
  Active state highlights both icon and background with white text and bg-white/5.
---

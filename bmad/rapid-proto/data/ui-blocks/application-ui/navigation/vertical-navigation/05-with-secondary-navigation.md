...
notes: |
  Dark vertical navigation with two distinct sections: primary nav with icons/badges and secondary nav with initial avatars.
  Primary section uses standard icon navigation with optional count badges.
  Secondary section has heading label and items with bordered initial badges (bg-gray-900).
  Uses gap-y-7 to separate sections, truncate utility for long secondary item names.
---

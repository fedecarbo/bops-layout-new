...
category: Navigation
element: Pagination
variant: Card footer with page buttons
tech: React
tailwind: v4.1
deps:
...
notes: |
  Dark-themed pagination component designed for card footers with border-top separator.
  Mobile view shows simple Previous/Next buttons, desktop displays full page number controls.
  Uses inset-ring utility for borders, indigo accent for active page state.
  Includes ellipsis for truncated page ranges and result count display on desktop.
---

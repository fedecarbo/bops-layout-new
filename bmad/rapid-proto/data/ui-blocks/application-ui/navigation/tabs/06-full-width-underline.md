...
category: Navigation
element: Tabs
variant: Full-width tabs with underline
tech: React
tailwind: v4.1
deps:
  - '@heroicons/react/16/solid'
tags: [navigation, tabs, full-width, responsive]
a11y:
...
notes: |
  Each tab uses w-1/4 to fill equal width.
  Adjust width classes based on tab count (w-1/3, w-1/5, etc).
  Mobile select mirrors current tab.

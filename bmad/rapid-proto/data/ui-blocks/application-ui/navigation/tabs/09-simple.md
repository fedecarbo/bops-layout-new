...
tags: [navigation, tabs, simple, responsive]
a11y:
  - "Uses role='list' on tab list"
  - "aria-label on select element"
  - "aria-hidden on chevron icon"
notes: |
  Minimal tab design with no underline or pills.
  Uses semantic ul/li list structure.
  Active tab uses indigo-400 text color only.
  Includes full page wrapper with max-w-7xl container.
---

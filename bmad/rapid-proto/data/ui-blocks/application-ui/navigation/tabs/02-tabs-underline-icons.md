...
category: Navigation
element: Tabs
variant: Tabs with underline and icons
tech: React
tailwind: v4.1
deps:
  - '@heroicons/react/16/solid'
  - '@heroicons/react/20/solid'
tags: [navigation, tabs, icons, responsive]
a11y:
...
notes: |
  Replace brand color classes as needed.
  Mobile select mirrors current tab.
  Icons are 20/solid for tabs, 16/solid for chevron.
---

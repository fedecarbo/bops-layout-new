...
a11y:
  ...
  - aria-hidden on icons and badge counts
  - sr-only label for profile link
notes: |
  Full-height dark sidebar with bg-gray-900 and border-right, includes before pseudo-element overlay (bg-black/10).
  Three sections: logo header (h-16), grouped navigation with icons/badges and teams with initials, profile footer with avatar.
  Profile uses mt-auto to stick to bottom, -mx-6 to extend full width with px-6 padding.
  Badges use bg-gray-900 with white text and outline-white/15, team initials have bg-white/5.
---

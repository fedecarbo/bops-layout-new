...
notes: |
  Full-height dark sidebar with bg-gray-900, border-right in before pseudo-element along with bg-black/10 overlay.
  Three sections: logo header, grouped navigation with icons/badges and teams, profile footer.
  Simplified icon styling (no conditional colors), team initials use consistent border-white/10 with hover states.
  Profile section uses mt-auto and -mx-6 for full-width bottom alignment.
---
